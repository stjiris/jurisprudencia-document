export const JurisprudenciaVersion = "jurisprudencia.14.0"
...
export const JurisprudenciaDocumentExactKeys = ["Número de Processo", "ECLI", "Fonte", "URL", "UUID", "Tipo", "PDF"] as const;
